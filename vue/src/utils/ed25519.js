 ...
 * RFC8032 5.1.5
 */
ed25519.getPublicKey = function getPublicKey(privateKey) {
 ...
 * RFC8032 5.1.6
 */
ed25519.sign = function sign(message, privateKey) {
 ...
 */
 ed25519.verify = function verify(sig, message, publicKey) {
  message = ensureBytes(message)
 ...
 */
 ed25519.getSharedSecret = function getSharedSecret(privateKey, publicKey) {
  const { head } = getExtendedPublicKey(privateKey)
  const u = Point.fromHex(publicKey).toX25519()
  return curve25519.scalarMult(head, u);
}

ed25519.toX25519 = function toX25519(publicKey) {
...
const utils = {
  ...
  hash: (message) => {
    ...
    return blake2b.blake2b(message);
  },
  /**
